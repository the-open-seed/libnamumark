...
void ast_node_print(ast_node *node){
    char** types = (char*[]){"AST_NODE_TYPE_ROOT", "AST_NODE_TYPE_TEXT", "AST_NODE_TYPE_BOLD", "AST_NODE_TYPE_ITALIC", "AST_NODE_TYPE_UNDERLINE", "AST_NODE_TYPE_STRIKE", "AST_NODE_TYPE_H1", "AST_NODE_TYPE_H2", "AST_NODE_TYPE_H3", "AST_NODE_TYPE_H4", "AST_NODE_TYPE_H5", "AST_NODE_TYPE_H6", "AST_NODE_TYPE_BLOCKQUOTE", "AST_NODE_TYPE_FOOTNOTE", "AST_NODE_TYPE_LINK", "AST_NODE_TYPE_COMMENT"};
